...
$$I_{i,t,z}=\beta_0 + \sum_{t = 2}^T\gamma_{i,t}Y_t + \beta_1Z_{i,z} + \beta_2P_{i,t,z}\times Z_{i,t,z} + \beta_3T_{i,t,z} + \beta_4V_{i,t,z} + \beta_5D_{i,t,z} + \epsilon_{i,t,z}$$
...
The scorecard (Fig. 4) shows that this reserve achieves a general score of 64%, suggesting  that  64% of indicators are positive. All category–level scores were also high, with values of 67%, 60%, and 75% positive indicators for biological, socioeconomic and governance, respectively.
